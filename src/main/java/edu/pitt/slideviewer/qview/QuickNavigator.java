...
public class QuickNavigator extends JPanel implements Navigator, 
    ...
    private boolean drag = false, showMold = true,resizing;
    private String imageName;
    private int offs = 3;
    
    public QuickNavigator(QuickViewer v){
    	viewer = v;
     ...
     * @param info
     */
    private void setImage(ImageInfo info, boolean resize){
		// don't do the same thing to same info
    	this.info = info;
    	if(info == null){
		    thumbnail = null;
		    imageName = null;
			...
			//int w = (size.width>10)?size.width-10:1;
			//int h = (size.height>10)?size.height-10:1;
    ...
    /**
     * draw mold in an image
     */
    private void drawMold(){
    	 if(thumbnail != null){
    		// draw viewport
